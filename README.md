...
```Dockerfile
FROM ripplesciencedocker/meteor-base:1.11.1
```

if your project is running under Meteor 2.0. See your app’s `.meteor/release` file to get its Meteor release version. This version must match an available tag from [disney/meteor-base](https://cloud.docker.com/repository/docker/geoffreybooth/meteor-base/tags).
